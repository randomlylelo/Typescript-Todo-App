(() => {
  ...
  var require_index3 = __commonJS((exports, module) => {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
  ...
  var require_index4 = __commonJS((exports, module) => {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
  ...
  var require_react_dom_development = __commonJS((exports) => {
    ...
    if (true) {
      (function() {
        "use strict";
        var React6 = require_index3();
        var _assign = require_index();
        var Scheduler = require_index4();
        var checkPropTypes = require_checkPropTypes();
...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  // src/Todo/TodoListItem.tsx
  const React4 = __toModule(require_index3());
  const TodoListItem2 = ({todo, toggleTodo}) => {
    return React4.createElement("li", null, React4.createElement("label", {
      style: {textDecoration: todo.complete ? "line-through" : void 0}
  ...
  const React3 = __toModule(require_index3());
  const TodoList2 = ({todos, toggleTodo}) => {
    return React3.createElement("ul", null, todos.map((todo) => React3.createElement(TodoListItem2, {
      key: todo.text,
      todo,
      toggleTodo
    })));
  ...
  // src/Todo/AddTodoForm.tsx
  const React2 = __toModule(require_index3());
  const AddTodoForm2 = ({addTodo}) => {
    const [text, setText] = React2.useState("");
    return React2.createElement("form", null, React2.createElement("input", {
      type: "text",
      value: text,
      onChange: (e) => {
  ...
  // src/App.tsx
  const React = __toModule(require_index3());
  const initialTodos = [
    {
      text: "Walk the dog",
      complete: false
  ...
  function App() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(AddTodoForm2, {
      addTodo
    }), React.createElement(TodoList2, {
      todos,
      toggleTodo
    }));
  }
  ...
  // src/index.tsx
  const React5 = __toModule(require_index3());
  const ReactDOM = __toModule(require_index2());
  ReactDOM.render(React5.createElement(React5.StrictMode, null, React5.createElement(App_default, null)), document.getElementById("root"));
})();
